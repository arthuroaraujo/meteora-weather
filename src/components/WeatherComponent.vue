  ...
  <v-card class="card" elevation="2">
    <div class="weather-div">
      <div class="date-inputs">
        <input type="date" class="custom-date-input" v-model="localStartDate">
...
export default defineComponent({
    ...
    headers(): any[] {
      if (this.mode === 'temperature') {
        return [
          ...
          { title: 'Temp. Aparente °C', value: 'apparent_temperature', align: 'center' },
  ...
  methods: {
    async handleFetch() {
      const validationMessage = validateDates(this.localStartDate, this.localEndDate);
      ...
      try {
        ...
        if (this.mode === 'temperature') {
          ...
          this.data = this.buildChart(list, [
